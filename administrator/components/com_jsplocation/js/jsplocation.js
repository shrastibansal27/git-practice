...
function SearchRadiusField(optionsValue){
if(optionsValue == "No"){
		document.getElementById("search_radius_location").style.display = "none";
	} 
else{
document.getElementById("search_radius_location").style.display = "";
}
}