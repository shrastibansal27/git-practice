...
<legend><?php echo JText::_( 'STATE_LIST' ); ?></legend>
...
<thead>
	<tr>
    <th colspan="4"><?php echo JText::_( 'STATE_LIST_DESC' ); ?></th>
    </tr>
	<tr>
		<th width="5">
...
<tbody>
	...
	<tr class="<?php echo "row$k"; ?>">
		...
		<td align="left">
			...
			<a href="<?php echo JURI::base(); ?>index.php?option=com_jsplocation&controller=state&task=edit&cid[]=<?php echo $row->id; ?>">
				<?php echo $row->title; ?>
            </a>
            </span>
		</td>
