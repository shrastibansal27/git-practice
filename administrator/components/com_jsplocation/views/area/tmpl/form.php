...
$document->addCustomTag('<script language="javascript" type="text/javascript" src="components/com_jsplocation/js/area.js"></script>');
...
?>
<?php 
$country_id		= JRequest::getVar( 'country_id',		'',			'get' );
$state_id		= JRequest::getVar( 'state_id',			'',			'get' );
$city_id		= JRequest::getVar( 'city_id',			'',			'get' );
?>
...
<div class="">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td align="left">
				 <?php echo $this->list['city']; ?>	
			</td>
		</tr>
		<tr>
			<td class="key">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'AREA' ); ?>">
				<label for="name">
			...
			<td align="left">
					<input type="text" id="area" name="area" value="<?php echo preg_replace('/[[:^print:]]/','',$this->data->title); ?>">
			</td>
		</tr>
		<tr>
			<td class="key">
...
<input type="hidden" name="task" value="area" />
