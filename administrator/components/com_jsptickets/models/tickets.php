...
class jspticketsModeltickets extends JModelAdmin {
	...
	public function getList($listOrder=null, $listDirn=null, $search, $typefilter, $catfilter, $filterFollow_up, $priorityfilter, $statusfilter, $assignedtofilter, $total )
	{
	...
	public function fltrCount($listOrder=null, $listDirn=null, $search, $typefilter, $catfilter, $filterFollow_up, $priorityfilter, $statusfilter, $assignedtofilter )
	{
		$mainframe = Jfactory::GetApplication();
		$context = JRequest::getVar('option');
		$limit		= $mainframe->getUserStateFromRequest('global.list.limit', 'limit', $mainframe->getCfg('list_limit'), 'int');
	...
	function getFormFeedbacks($tid = null)
	{
		...
		$query = "select * from `#__jsptickets_feedbacks` where `ticket_id` = ".$tid." order by `created` DESC";
