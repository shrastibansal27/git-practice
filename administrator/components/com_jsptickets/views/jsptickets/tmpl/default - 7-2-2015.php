...
LIMIT 0 , 5';
        ...
        {
           name: '<?php echo $top_username[0]['username']; ?>',
...
$(function () {
   ...
   <div class="col-md-6 new-row">
		...
		<div class="desc col-n" style="text-align:center;">
		...
		<div id="heightdiv" style="height:20px;"></div>
		<div class="col-md-12 col-n">  <?php echo JText::_('JSPTICKETS_FEEDS_GUEST_TICKETS')." ".$this->countguesttickets(); ?> </div>
		<div id="heightdiv" style="height:20px;"></div>
