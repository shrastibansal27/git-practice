...
<form  class="form-validate" name="adminForm" id="adminForm" method="post" action="index.php?option=com_jsptickets&task=jsptickets" enctype="multipart/form-data" onsubmit="return ">
	...
	<table class="table table-striped">
		...
		<tbody>
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_jsptickets&controller=prioritylist&task=edit&id='.$item->id);?>">
				...
				<?php } } else {
					echo '<tr><td colspan="4"><center><h5>'.JText::_("NO_PRIORITY_TO_DISPLAY").'</h5></center></td></tr>';
				}?>
		</tbody>
		<tfoot>
			<tr>
...
<input type="hidden" name="controller" value="prioritylist" />
<input type="hidden" name="task" value="prioritylist" />
