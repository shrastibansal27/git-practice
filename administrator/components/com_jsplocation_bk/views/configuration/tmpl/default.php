...
<div class="tab-pane active" id="googlemap">
   <fieldset class="adminform">
	...
	<tr>
	   <td class="paramlist_key">
	      <span class="editlinktip hasTip" title="<?php echo JText::_('BING_MAP_KEY'); ?>" id="bing_keylabel" style="display:none">
		     <?php echo JText::_('BING_MAP_KEY'); ?>
		  </span>
	   </td>
	   <td class="paramlist_value">
	      <input name="bing_key" id = "bing_key" type="text" value="<?php echo $params['BingMap_key']; ?>" style="display:none" size="20" />
	   </td>
	</tr>
	<tr>
		<td class="paramlist_key">
...
<script type="text/javascript">
	...
	// var locationstatus = locationstatus.options[locationstatus.selectedIndex].value;
	
    // branchstatus(locationstatus);
