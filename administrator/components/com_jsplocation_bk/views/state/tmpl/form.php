...
$document->addCustomTag('<script language="javascript" type="text/javascript" src="components/com_jsplocation/js/states.js"></script>');
...
<div class="">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input type="text" id="state" name="state" value="<?php echo preg_replace('/[[:^print:]]/','',$this->data->title); ?>">
			</td>
		</tr>
		<tr>
			<td class="key">
            	<span class="editlinktip hasTip" title="<?php echo JText::_( 'PUBLISHED' ); ?>">
				<label for="name">
...
<input type="hidden" name="task" value="state" />
