...
class PHPExcel_Shared_Font
{
	...
	public static $defaultColumnWidths = array(
		'Arial' => array(
			 1 => array('px' => 24, 'width' => 12.20000000),
			 2 => array('px' => 24, 'width' => 12.20000000),
		...
		switch ($font->getName()) {
			case 'Arial':
				switch ($font->getSize()) {
					...
					case 9:
						// inspection of Arial 9 workbook says 12.20pt ~16px
						$rowHeight = 12;
						break;
			...
			case 'Calibri':
				switch ($font->getSize()) {
					...
					case 9:
						// inspection of Calibri 9 workbook says 12.20pt ~16px
						$rowHeight = 12;
						break;
