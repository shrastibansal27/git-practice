...
CREATE TABLE IF NOT EXISTS `#__jsplocation_configuration` (
 ...
 `GoogleMap_key` varchar(200) NOT NULL,
 ...
 `imagename` varchar(256) NOT NULL,
 `GoogleMap_DIR_key` varchar(200) NOT NULL,
...
INSERT INTO `#__jsplocation_configuration` (`id`, `maptitle`, `map_type`,`GoogleMap_key`,`BingMap_key`, `jquery`, `height`, `zoomlevel`, `lat_ovr_conf`, `long_ovr_conf`, `branch_id`, `branch_url`, `search`, `directions`, `branchlist`, `country`, `state`, `city`, `area`, `displaytitle`, `zip_search`, `category_search`, `country_search`, `state_search`, `city_search`, `area_search`, `google_autocomplete_address`, `radius_range`, `template`, `min_zip`, `max_zip`, `locateme`, `locateme_radius`, `branch_img_id`, `image_display`, `imagename`,`GoogleMap_DIR_key`,`direction_range`, `show_pointer_type`, `page_limit`, `pointertype`, `fillcolor`, `fontsize`, `file_type`, `file_path`, `location_status`, `location_file_type`, `location_file_path`) VALUES
...
CREATE TABLE `#__jsplocation_map_lang` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pziar_jsplocation_map_lang`
--

INSERT INTO `#__jsplocation_map_lang` (`id`, `map_language`, `map_language_code`) VALUES
(1, 'Arabic', 'ar'),
(2, 'Bulgarian', 'bg'),
(3, 'Chinese', 'zh'),
(4, 'English', 'en'),
