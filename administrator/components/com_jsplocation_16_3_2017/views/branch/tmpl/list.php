...
<thead>
	<tr>
		...
		<th class="title">
			<?php echo JText::_( 'BRANCH_NAME_LIST' ); ?>
		</th>
		<th class="title">
			<?php echo JText::_( 'ADDRESS_LIST' ); ?>
		</th>
		<th class="title">
			<?php echo JText::_( 'ZIP_LIST' ); ?>
		</th>
		<th class="title">
			<?php echo JText::_( 'PUBLISHED_LIST' ); ?>
		</th>
		<th class="title">
			<?php echo JText::_( 'Location ID' ); ?>
		</th>
	</tr>
...
<tbody>
	...
	<tr class="<?php echo "row$k"; ?>">
		...
		<td align="left">
        	<span class="editlinktip hasTip" title="<?php echo JText::_( 'EDIT' );?>::<?php echo htmlspecialchars(preg_replace('/[[:^print:]]/','',$row->branch_name)); ?>">
			<a href="<?php echo JURI::base(); ?>index.php?option=com_jsplocation&controller=branch&task=edit&cid[]=<?php echo $row->id; ?>">
            	<?php echo preg_replace('/[[:^print:]]/','',$row->branch_name); ?>
            </a>
            </span>
		</td>	
		<td align="left">
