...
class JspLocationViewConfiguration extends JViewLegacy {
	...
	function display($tpl=null)
	{
		...
		$searchRadiusValue = $params['search_radius'];
		$searchradius = $params['search_radius'];
		$searchradiusList[] = JHTML::_( 'select.option', $searchRadiusValue, $searchradius, 'id', 'search_radius');
		$searchradiusList[] = JHTML::_( 'select.option', '5', "5", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '10', "10", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '15', "15", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '25', "25", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '50', "50", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '100', "100", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '500', "500" , 'id', 'search_radius');
		$searchradiusList[] = JHTML::_( 'select.option', '1000', "1000", 'id', 'search_radius' );
		$searchradiusList[] = JHTML::_( 'select.option', '2000', "2000", 'id', 'search_radius' );
		$list['searchradius']  = JHTML::_( 'select.genericlist', $searchradiusList, 'search_radius','class="droplist"', 'id', 'search_radius');
		
        $map_lang = $model->getMapLanguage();
		$map_lang_code = $model->getMapLanguageData();
		$this->addToolbarform();
		$this->assignRef("list",$list);	
        $this->assignRef("map_lang",$map_lang);
		$this->assignRef("map_lang_code",$map_lang_code);
	    parent::display($tpl);
	}
