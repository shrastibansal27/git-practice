...
$document->addCustomTag('<script language="javascript" type="text/javascript" src="components/com_jsplocation/js/category.js"></script>');
...
<div class="">
	<fieldset class="adminform">
		...
		<tr>
			<td class="key">
            	<span class="editlinktip hasTip" title="<?php echo JText::_( 'CATEGORY' ); ?>">
				<label for="name">
			...
			<td>
				<input type="text" id="category" name="category" value="<?php echo $this->data->title; ?>">
			</td>
		</tr>
		<tr>
			<td class="key">
