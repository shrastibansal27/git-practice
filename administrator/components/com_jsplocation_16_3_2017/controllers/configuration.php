...
class jspLocationControllerConfiguration extends JControllerLegacy {
	...
	function save($tpl = null){
		...
		if($map_type==0)
	     ...
	     $googleMap_key = ltrim(JRequest::getVar('google_key', '','post'));
		   ...
		   { 
	        ...
	        $googleMap_key = $params['GoogleMap_key'];
		   }
		$googleMap_key = ltrim(JRequest::getVar('google_key', '','post'));
		$bingMap_key =  ltrim(JRequest::getVar('bing_key', '','post'));
		...
		$language_local =JRequest::getVar('language_local', '', 'post');
		...
		$search_radius_status = JRequest::getVar('searchradiusloc', '', 'post');
		$search_radius = JRequest::getVar('search_radius', '', 'post');
		...
		$google_dir_key = JRequest::getVar('google_dir_key', '', 'post');
		...
		search_radius_status = '".$search_radius_status."',
		...
		GoogleMap_DIR_key   =   '".$google_dir_key."',
