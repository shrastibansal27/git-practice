...
<!-- display button -->
 ...
 <div id="container-security" style="min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto">
...
<script type="text/javascript">
    ...
    $('#container-security').highcharts({
        ...
        title: {
            text: 'jSecure<br>Security<br>Level',
            align: 'center',
...
<div id="container_pie_country" style="height: 400px">
<?php 
...
<div id="div_enable"> 
    <?php echo "Jsecure On/Off"; 
    $jsecure_enable = $JSecureConfig->publish; 
    if($jsecure_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo "Captcha"; 
    $captcha_enable = $JSecureConfig->captchapublish;
    if($captcha_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo "Auto ban"; 
    $autoban_enable = $JSecureConfig->abip;
    if($autoban_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo "Master Password"; 
    $masterPassword_enable = $JSecureConfig->enableMasterPassword;
    if($masterPassword_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo "Master Login Control"; 
    $login_control_enable = $JSecureConfig->login_control;
    if($login_control_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo "Administrator Password Protection"; 
    $adminpasswordpro_enable = $JSecureConfig->adminpasswordpro;
    if($adminpasswordpro_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
<div id="div_enable"> 
    <?php echo " Email Scan"; 
    $email_enable = $JSecureConfig->publishemailcheck;
    if($email_enable == 1){echo "enable";}else{echo "disable";}
    ?>
</div>
</div>
