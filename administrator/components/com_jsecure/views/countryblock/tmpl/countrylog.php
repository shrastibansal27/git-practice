...
<ul class="nav nav-tabs">
  <li><a href="#countryblockstatus" data-toggle="tab" onclick="switch_tab()"><?php echo JText::_('COUNTRY_BLOCK'); ?></a></li>
  <li class="active"><a href="#countrylogs" data-toggle="tab" ><?php echo JText::_('LOGS'); ?></a></li>
...
<input type="hidden" id="task" name="task" value="countrylog"/>
