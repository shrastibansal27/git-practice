...
<form  class="form-validate" name="adminForm" id="adminForm" method="post" action="<?php echo JRoute::_('index.php?option=com_jsptickets&task=jsptickets');?>" enctype="multipart/form-data">
	...
	<div id="filter-bar" class="btn-toolbar">
		...
		<div class="jsptickets_toolbar_grid nav-collapse collapse">
			...
			<div class="btn-group">
				&nbsp;<input class="btn btn-danger" type="submit" name="delete" value="Delete" onclick ="return Remove()">
				</input>
			</div>
			<div class="btn-group">
				&nbsp;<input class="btn btn-danger" type="button" name="cancel" value="Cancel" onclick ="return ListClose()">
				</input>
			</div>
		</div>
		...
		<table class="table-bordered adminlist ticket-table table-hover table-striped adminlist" cellpadding="0" cellspacing="0" border="0">
			<thead>
				<tr class="row<?php echo $j % 2; ?>">
					...
					<th class="text-center" width="250px"> <?php echo JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder); ?> </th>
				...
				<!--	<th class="text-center"> <?php echo JHtml::_('grid.sort', JText::_('ASSIGNED_TO'), 'a.assigned_to', $listDirn, $listOrder); ?> </th>  -->
					...
					<th style="text-align:left;"> <?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.status_id', $listDirn, $listOrder); ?> </th>
			...
			?>
				<tr class="info row<?php echo $j % 2; ?>">
				...
				<!--	<td><?php if(isset( $item->assigned_to) && $item->assigned_to!=0 )
					...
					<td style="text-align:left;"><span class="<?php echo $class;?>"><?php echo $this->ticketstatus($item->status_id); ?></span></td>
