...
<form class="form-validate" id="adminForm" name="adminForm" method="post" action="index.php?option=com_jsptickets&task=prioritylist" enctype="multipart/form-data" onsubmit="return false;">
<?php echo $this->form->getInput('id', null, $this->priorityid);?>
...
<table class="admintable" width="100%">
	<tbody>		
		<tr>
			...
			<td>
				<?php echo $this->form->getInput('name', null , $this->priorityname); ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php echo $this->form->getInput('publish', null , $this->prioritypublish); ?>
			</td>
		</tr>
				
		<tr>
			<td>
				<?php echo JHTML::tooltip(JText::_('PRIORITY_DESCRIPTION_DESC'), JText::_('PRIORITY_DESCRIPTION_LABEL'), '', JText::_('PRIORITY_DESCRIPTION_LABEL'));?>
			</td>
			<td>
				<?php echo JFactory::getEditor()->display('description', $this->prioritydescription ,'350','250','40','6',array('pagebreak', 'readmore', 'image', 'article')); ?>
			</td>
		</tr>
	</tbody>
</table>
...
<input type="hidden" name="controller" value="priorityform" />
<input type="hidden" name="task" value="priorityform" />
