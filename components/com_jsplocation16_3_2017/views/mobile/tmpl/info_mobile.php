...
$document->addScript(JURI::base() . 	"components/com_jsplocation/scripts/jquery.mobile-1.4.5.min.js");
$document->addScript(JURI::base() . 	"components/com_jsplocation/scripts/jquery-1.10.2.min.js");
        ...
        <div class="info_body">
				...
				?>
                	...
                	<div id="slider" class="info_right_wrap">
					  ...
					  <ul>
						...
						?>
						<li><img src="images/jsplocationimages/jsplocationImages/<?php echo $branchname.'/'.$brimg;?>" width = "417px" height="417px"/></li>
						<?php
						} 
						?>
			...
			<div class="clearfix"></div>
						...
						<p class="heading">Address:
							...
							<div class="accordion">
							<p class="heading">More Info:<span class="glyphicon glyphicon-plus" style="float:right;"></span></p>
							</div>
...
<script type="text/javascript">
	...
	$j(document).ready(function() {
		...
		/*-----------Slider Code ----------*/
		/*-----------Swiper Code ----------*/
		$j("div.info_right").on("swipeleft",function(){
		$j( event.target ).addClass( "swipeleft" );
