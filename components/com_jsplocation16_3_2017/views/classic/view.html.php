...
class jsplocationViewclassic extends JViewLegacy {
	...
	function redirectviewinfo($serverpath,$storeid,$tpl=null){
	...
	function redirectviewbranchlist($selectedCategory,$tpl=null){
	...
	function directionview($storeid,$tpl=null){
