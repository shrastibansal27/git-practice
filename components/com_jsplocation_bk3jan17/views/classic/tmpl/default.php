  ...
  <div class="jsp_map_block">
	...
	<div class="jsp_wrap">
		...
		<a href="#" style="color:#686868 !important;" onclick="return getGeoloc();" title="<?php echo JText::_('LOCATE_ME_DESC'); ?>">Locate me</a><img class="locate_not" src="<?php echo JURI::base();?>components/com_jsplocation/images/locate.png"><span><i class="fa fa-angle-right"></i></span>				
         ...
         <!-- <button class="btn btn-skyblue locator caps pull-right" value="<?php echo JText::_('LOCATE_ME'); ?>" onclick="return getGeoloc();" type="button" title="<?php echo JText::_('LOCATE_ME_DESC'); ?>"> <?php echo JText::_('LOCATE_ME'); ?> <i class="icon-16-locate"></i> </button> -->
          <?php
						}
						?>
          <!--Locate Me button ends here-->
						...
						<!-- <div class="reset"><a onclick="funcreset( 'resetvalue' );" title="<?php echo JText::_('RESET_DESC'); ?>" href="#">Reset</a></div>  -->
						
              <!-- <button class="btn btn-orange caps" type="submit" onclick="funcreset( 'resetvalue' );" title="<?php echo JText::_('RESET_DESC'); ?>"><?php echo JText::_('RESET'); ?></button> -->
            </div>
			...
			<div class="jsp_body" id="jsp_wrap_body">
				...
				$site 			= 	((in_array("Website", $Fields)) and ($brachresult->website != '')) ? $site = "<div class=\"jsp_loc_marker_fields\"><span>".JText::_('WEBSITE_MARKER')."&nbsp;</span><a href=".$brachresult->website." target=\"_blank\" class=\"jsp_floatNone\">".$brachresult->website."</a></div>": $site = "";
                        ...
                        $directionHtml = 
                                   ...
                                   '<\/form><\/div>  --> <a class="branch_view1" href="'.JURI::base().'index.php?option=com_jsplocation&view=classic&task=redirectviewinfo&id='.$brachresult->id.'&tmpl=component">View branch details<i class="fa fa-angle-right arrow_txt"></i></a></div>';
                        }
						else{
                        $directionHtml = 
                                   '<!-- <div class=\"jsp_loc_marker_fields\"><a href=\"javascript:tohere(0)\" id=\"toLink\" style=\"font-weight:bold;\" title="'.JText::_('TO_HERE_DESCRIPTION').'">'.JText::_('TO_HERE').'<\/a> - <a href=\"javascript:fromhere(0)\" id=\"fromLink\" title="'.JText::_('FROM_HERE_DESCRIPTION').'">'.JText::_('FROM_HERE').'<\/a>' .
                                   ...
                                   '<span title=\"'.JText::_('WALK_DESCRIPTION').'\">'.JText::_('WALK').' <input type=\"checkbox\" title=\"'.JText::_('WALK_DESCRIPTION').'\" name=\"walk\" id=\"walk\" \/><\/span>&nbsp; <span title=\"'.JText::_('AVOID_HIGHWAYS_DESCRIPTION').'\">'.JText::_('AVOID_HIGHWAYS').' <input type=\"checkbox\" title=\"'.JText::_('AVOID_HIGHWAYS_DESCRIPTION').'\" name=\"highways\" id=\"highways\" \/><\/span>' .
                                   '<input type=\"hidden\" id=\"sourceDetails\" value=\"' . $lat . ',' . $long . '\"\/>' .
                                   '<\/form><\/div>  --> <a class="branch_view1" href="'.JURI::base().'index.php?option=com_jsplocation&view=classic&task=redirectviewinfo&id='.$brachresult->id.'">View branch details<i class="fa fa-angle-right arrow_txt"></i></a></div>';
						...
						//$branchDetails .='<a href="#">View branch details ></a>';
						...
						if (strpos($_SERVER['QUERY_STRING'],'tmpl=component') !== false) 
                        {
                        $branchDetails .='<a href="index.php?option=com_jsplocation&view=classic&task=redirectviewinfo&id='.$brachresult->id.'&tmpl=component" class="branch_view">View branch details<i class="fa fa-angle-right"></i></a></div></div>';
                        }
                        else
                        {
                        $branchDetails .='<a href="index.php?option=com_jsplocation&view=classic&task=redirectviewinfo&id='.$brachresult->id.'" class="branch_view">View branch details<i class="fa fa-angle-right"></i></a></div></div>';
                        }
					...
					<div class="img_map" style="height: <?php echo $configParams[0]->height - 2; ?>px">
                       ...
                       function getDirections(unit)
					   {
						...
						{	
							...
							var locations = [
        {lat: 40.707491, lng: -74.0116385},
        {lat: 51.5145558, lng: -0.0859578},
        {lat: 19.1175317, lng: 72.8836678},
        {lat: 48.1764801, lng: 11.5632549},
        {lat: 18.9294644, lng: 72.8331099},
      ]
        ...
        var markerCluster = new MarkerClusterer(map, markers,
            {imagePath: 'https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m'});
							...
							function createTabbedMarker(pinstr, pointertype, fillcolor, fontsize, branch_id_disp, point, contactDetails, branchDirection, branchAddress, title, description, pointerImage ,label1, label2,branchimage,style)
							{
								...
								side_bar_html += '<li id="locationli" onclick="CngClass(this);"><a id="brnotify" class="jsp_loc_branchdetails branch_notification" href="javascript:myclick(' + (overlays.length-1) + ');" id="'+title.replace(/[" "]/g,"-")+'" title="<?php echo JText::_('LOCATION_LIST_TITLE');?>">' + branchAddress + '<\/a>';
