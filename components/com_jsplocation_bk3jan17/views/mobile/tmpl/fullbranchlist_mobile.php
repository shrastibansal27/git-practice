	...
	<div class="jsp_wrap">
    	<div class="jsp_head">
        	<div class="jsp_info_titlewrap">
                ...
                $submitUrl = JURI::base().'index.php?option=com_jsplocation&view=mobile&task=redirectviewbranchlist_mobile&tmpl=component';
                    }
                      else
                        {
                        
               $submitUrl = JURI::base().'index.php?option=com_jsplocation&view=mobile&task=redirectviewbranchlist_mobile';
                    } 
				?>
				...
				<form action="<?php echo $submitUrl;?>" method="post" name="category_form" id="category_form" onchange="return formsubmitfunction();">
					...
					<input type="hidden" name="task" value="redirectviewbranchlist_mobile" />
				</form>	
        ...
        <div class="info_body">
            	...
            	<div class="list_left">
                	<div class="list_info">
                       <p class="list_info_title">Branch List</p>
                        ...
                        <a href="<?php echo JURI::base().'index.php?option=com_jsplocation&view=mobile&task=redirectviewinfo_mobile&id='.$branchid;?>&tmpl=component"><?php echo $branchname;?></a><?php echo ' - '.$cityname.', '.$countryname; ?> 
                        <?php    }
                      else
                        {
                        ?>
                         <a href="<?php echo JURI::base().'index.php?option=com_jsplocation&view=mobile&task=redirectviewinfo_mobile&id='.$branchid;?>"><?php echo $branchname;?></a><?php echo ' - '.$cityname.', '.$countryname; ?> 
                        <?php     }
            ...
            <div class="jsp_fullscr">
                ...
                <?php if (strpos($_SERVER['QUERY_STRING'],'tmpl=component') !== false) 
                        {
                        ?>
                <a href="<?php echo JURI::base().'index.php?option=com_jsplocation&view=mobile&Itemid='.$menuItem->id;?>&tmpl=component"><i class="fa fa-home"></i></a>
                <?php    }
                      else
                        {
                        ?>
                <a href="<?php echo JURI::base().'index.php?option=com_jsplocation&view=mobile&Itemid='.$menuItem->id;?>"><i class="fa fa-home"></i></a>
                <?php     } ?>
                </div>
                ...
                <?php if (strpos($_SERVER['QUERY_STRING'],'tmpl=component') === false) 
                        {
                        ?>
                <div class="prev full_right_lastpage"><a target="_blank" href="<?php echo JRoute::_('index.php?option=com_jsplocation&view=mobile&task=redirectviewbranchlist_mobile&tmpl=component');?>">Fullscreen<img src="images/jsplocationimages/fullscr.png"></a></div>
                <?php     } ?>
           </div>
         </div>  
        </div>
