					...
					<div class="img_map" style="height: <?php echo $configParams[0]->height - 2; ?>px" id="jsp_main_map">
					   ...
					   {	
						...
						{	
							...
							side_bar_html += '<li id="locationli" style="cursor:pointer" onclick="javascript:myclick(' + (overlays.length-1) + ');" title="<?php echo JText::_('LOCATION_LIST_TITLE');?>"><a class="jsp_loc_branchdetails branch_notification" href="javascript:myclick(' + (overlays.length-1) + ');" id="'+title.replace(/[^\x00-\x7F]/g,"")+'" title="<?php echo JText::_('LOCATION_LIST_TITLE');?>">' + branchAddress + '<\/a>';
